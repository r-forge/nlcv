...
outtable <- topFeatures(nlcvRF_R, n = 10)
...
<<selGenes, fig = FALSE, echo = FALSE, results=tex>>=
outtable <- topFeatures(nlcvRF_SS, n = 12)
...
outtable <- topFeatures(nlcvTT_WS, n = 7)
...
outtable <- topFeatures(nlcvRF_WS, n = 7)
...
<<selGenes, fig = FALSE, echo = FALSE, results=tex>>=
outtable <- topFeatures(nlcvTT_SHS, n = 7)
xtable(outtable, label = "tab:selGenes_SHS1",
		caption="Top 20 features selected with t-test across all runs of the nested loop cross-validation.")
@

<<selGenes, fig = FALSE, echo = FALSE, results=tex>>=
outtable <- topFeatures(nlcvRF_SHS, n = 7)
...
<<selGenes, fig = FALSE, echo = FALSE, results=tex>>=
outtable <- topFeatures(nlcvTT_WHS, n = 10)
xtable(outtable, label = "tab:selGenes_WHS1",
		caption="Top 20 features selected with t-test across all runs of the nested loop cross-validation.")
@

<<selGenes, fig = FALSE, echo = FALSE, results=tex>>=
outtable <- topFeatures(nlcvRF_WHS, n = 10)
